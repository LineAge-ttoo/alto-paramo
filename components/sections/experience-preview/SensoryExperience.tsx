...
export default function SensoryExperience() {
    ...
    return (
        <section className="relative overflow-hidden bg-gradient-to-b from-[#181612] via-[#1a1512] to-[#1c1814] py-28 sm:py-36 md:py-44">
            {/* Ambient atmospheric mist & botanical light pools */}
            <div
                className="pointer-events-none absolute inset-0"
                style={{
                    background:
                        "radial-gradient(circle at 50% 30%, rgba(215,193,138,0.08), transparent 60%), radial-gradient(circle at 85% 70%, rgba(196,98,85,0.06), transparent 50%), radial-gradient(circle at 15% 65%, rgba(91,122,73,0.06), transparent 50%)"
                }}
            />
