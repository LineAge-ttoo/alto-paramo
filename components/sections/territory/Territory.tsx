      ...
      <div className="mx-auto max-w-7xl px-8 py-28">
        ...
        <h2
          className="
                    ...
                    "
        >
          Antes del café, existe el paisaje.
        </h2>
        ...
        <p
          className="
                    ...
                    "
        >
          Alto Páramo nace en las montañas del Macizo Colombiano. Nuestro café
          es consecuencia del agua, del bosque, de la biodiversidad y de las
          familias cafeteras.
        </p>
